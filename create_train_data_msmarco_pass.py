...
def main():
    ...
    parser.add_argument("--tokenizer_model", default='bert', type=str, required=False,
                            help=f"The name of the model must be in : {set(TOKENIZER_CLASSES.keys())}")
    parser.add_argument("--tokenizer", default='bert-base-uncased', type=str, required=False,
    ...
    tokenizer_class = TOKENIZER_CLASSES[args.tokenizer_model.lower()]
